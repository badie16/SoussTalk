...
const ChatSidebar = ({ profileImage = "/placeholder.svg?height=40&width=40" }) => {
  return (
    <div className="fixed left-0 top-0 bottom-0 w-[60px] bg-[#2e2e2e] flex flex-col items-center py-6 z-10">
      ...
      <div className="flex flex-col items-center space-y-8 flex-1">
        <NavIcon icon="user" to="#" active={false} />
        <NavIcon icon="message-square" to="#" active={true} />
        <NavIcon icon="users" to="#" active={false} />
        <NavIcon icon="phone" to="#" active={false} />
        <NavIcon icon="bookmark" to="#" active={false} />
        <NavIcon icon="settings" to="#" active={false} />
      </div>
