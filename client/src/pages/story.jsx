...
import { getActiveStories, createStory, uploadMedia } from "../services/storyService";
...
const Stories = () => {
  ...
  const handleAddStory = async () => {
    if ((activeTab === "media" && !selectedFile) || (activeTab === "text" && !textContent.trim())) {
      return;
    }
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
          <div className="bg-gray-800 rounded-lg w-full max-w-md p-4">
            <div className="flex border-b border-gray-600 mb-4">
              <button
                className={`py-2 px-4 font-medium ${activeTab === "media" ? "text-blue-400 border-b-2 border-blue-400" : "text-gray-400"}`}
                onClick={() => setActiveTab("media")}
              >
                Photos & videos
              </button>
              <button
                className={`py-2 px-4 font-medium ${activeTab === "text" ? "text-blue-400 border-b-2 border-blue-400" : "text-gray-400"}`}
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                ...
                disabled={loading || (activeTab === "media" && !selectedFile) || (activeTab === "text" && !textContent.trim())}
              >
      ...
      <div className="bg-gray-800 rounded-lg shadow p-4">
        ...
        {stories.length > 0 ? (
          ...
          <p className="text-gray-400 text-center py-8">No viewed stories</p>
        )}
      </div>
    </div>
  );
