			...
			<div className="fixed left-0 top-0 bottom-0 w-[60px] bg-[#2e2e2e] flex flex-col items-center py-6 z-10">
				...
				<div className="flex flex-col items-center space-y-8 flex-1">
					...
					<NavIcon
						...
						to="/story" // Direct link to profile page
					/>
				...
				{isLoading ? (
					...
					<div>
						...
						<div className="px-4 mt-2">
							<h2 className="text-xs font-semibold text-gray-400 mb-3 tracking-wider">
								ONLINE FRIENDS
							</h2>
					...
					{friend.avatar ? (
						...
						<div
							className={`h-10 w-10 rounded-full flex items-center justify-center ${
								friend.name.includes("Miranda Valentine") ||
								friend.name.includes("Dean Vargas")
									? "bg-purple-100 text-purple-600"
									: friend.name.includes("Zimmerman") ||
									  friend.name.includes("Badie")
...
const NavIcon = ({ icon, active, onClick, to }) => {
	...
	const chatAnimation =
		icon === "message-square" && active ? "animate-bounce-subtle" : "";
